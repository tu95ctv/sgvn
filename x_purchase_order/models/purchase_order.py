...
class PurchaseOrder(models.Model):
    ...
    def _check_qty_line_product(self, line):
        ...
        if not line.product_id.po_qty_confirm or line_qty <= line.product_id.po_qty_confirm:
            return True
        return False
    ...
    def _check_amount_line_product(self, line):
        ...
        if not line.product_id.po_amount_confirm or line_amount <= line.product_id.po_amount_confirm:
            return True
        return False
