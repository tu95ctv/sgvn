...
class ResCompany(models.Model):
    ...
    notes_construction_contract = fields.Html("Notes on construction contract", default=_get_default_notes_construction_contract, copy=False, translate=html_translate, sanitize=False)
    estimated_subcontracting_work = fields.Html("Estimated price and estimated period for subcontracting work", default=_get_default_estimated_subcontracting_work, copy=False, translate=html_translate, sanitize=False)
