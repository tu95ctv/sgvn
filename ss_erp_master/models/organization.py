...
class Organization(models.Model):
    ...
    organization_country_id = fields.Many2one("res.country", string="Organization address / country", default=lambda self: self.env.ref('base.jp', raise_if_not_found=False))
